...
class ExtendedKalmanFilter(object):
    ...
    def forwardDynamics(self):
        ...
        if len(self.priorMeans) > 100:
            self.priorMeans.pop(0)
        if len(self.priorCovariances) > 100:
            self.priorCovariances.pop(0)
    ...
    def updateEstimate(self, z_t):
        ...
        if len(self.posteriorMeans) > 100:
            self.posteriorMeans.pop(0)
        if len(self.posteriorCovariances) > 100:
            self.posteriorCovariances.pop(0)
